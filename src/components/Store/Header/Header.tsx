...
import {toggleSellerAccount, toggleSellerSidebar} from "@/hooks/useToggle";
...
const Header: React.FC = () => {
    return (
        <header className="fixed flex items-center h-64_ px-6 bg-contrast-0 border-b border-neutral-200 duration-500 store-header">
            ...
            <div id="seller-account-toggle" className="relative flex gap-4 items-center cursor-pointer" onClick={toggleSellerAccount}>
                ...
                <div id="seller-account" className="absolute top-[120%] right-0 flex flex-col gap-4 w-261_ p-4 bg-contrast-0 border border-neutral-300 rounded-sm duration-500 hide-seller-account">
                    ...
                    <Link className="h-11 p-2 bg-contrast-0 border border-neutral-300 rounded-lg leading-6.5 text-sm font-semibold text-neutral-950 text-center" href={'/'}>Back
                        to Buyer Account</Link>
                </div>
            </div>
        </header>
    );
